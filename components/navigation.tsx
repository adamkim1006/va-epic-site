...
export function Navigation() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/80 bg-card/92 backdrop-blur-md">
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <a
              ...
              className="hidden md:flex items-center gap-2 text-sm font-medium text-muted-foreground transition-colors hover:text-primary"
            >
